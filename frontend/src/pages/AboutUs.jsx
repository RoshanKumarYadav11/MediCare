  ...
  const features = [
    {
      ...
      title: "Expert Team",
      description:
        "Our team comprises highly skilled professionals committed to providing top-notch healthcare services.",
      icon: "👩‍⚕️",
    },
    {
      id: 2,
      ...
      description:
        "We tailor our treatments to meet individual patient needs for a better and healthier outcome.",
      icon: "💖",
    },
    {
      id: 3,
      ...
      description:
        "We use advanced technology and modern facilities to ensure the highest quality care.",
      icon: "🏥",
    },
  ];
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-lg leading-relaxed mb-4">
              At <span className="text-teal-600 font-semibold">MediCare</span>,
              we are passionate about transforming healthcare. Our team combines
              expertise, compassion, and advanced technology to deliver
              personalized and exceptional care for every patient.
            </p>
            <p className="text-lg leading-relaxed">
              From routine checkups to specialized treatments, we are here to
              support your health journey and provide a seamless experience
